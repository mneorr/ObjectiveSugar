...
@interface NSSet<__covariant ObjectType> (Accessors)
...
@property(readonly, nullable) ObjectType sample;
 ...
 */
- (NSArray *)map:(nullable id (^)(ObjectType object))block;
 ...
 **/
- (nullable id)reduce:(nullable id (^)(id __nullable accumulator, ObjectType object))block;

/**
 Same as -reduce, with initial value provided by yourself
 **/
- (nullable id)reduce:(nullable id)initial withBlock:(nullable id (^)(id __nullable accumulator, ObjectType object))block;


#pragma mark - Deprecations

@property(readonly, nullable) ObjectType first DEPRECATED_MSG_ATTRIBUTE("Please use -firstObject");
@property(readonly, nullable) ObjectType last  DEPRECATED_MSG_ATTRIBUTE("Please use -lastObject");
